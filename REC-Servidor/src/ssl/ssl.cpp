...
Server::Server(QObject *parent) : QTcpServer (parent) {
    ...
    settings_->setValue("key", "/home/migue/Escritorio/videovigilancia-1415-g04/REC-Servidor/SSL/server.key");
    settings_->setValue("certificate", "/home/migue/Escritorio/videovigilancia-1415-g04/REC-Servidor/SSL/server.crt");
